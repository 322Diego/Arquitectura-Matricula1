...
public class RegistroMatricula extends javax.swing.JInternalFrame {
    ...
    if (texto.matches("[a-zA-Z\\s]+")) { // El patrón "[a-zA-Z\\s]+" verifica que el texto contenga solo letras y espacios
        return true; // El texto contiene solo letras
    } else {
        JOptionPane.showMessageDialog(this, "Por favor, ingresa solo letras en el campo Nombre.", "Error", JOptionPane.ERROR_MESSAGE);
        return false; // El texto contiene caracteres que no son letras
    }
}
    private boolean validarDni(JTextField textField) {
    String texto = textField.getText().trim(); // Obtener el texto del JTextField y eliminar espacios en blanco
